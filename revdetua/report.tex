...
Por fim, foram realizadas análises comparativas entre os resultados obtidos com as diferentes abordagens, nomeadamente em termos de .... !!! % precisão, eficiência e consumo de memória, de modo a identificar as vantagens e desvantagens de cada método.
...
Não sendo a determinação desta medida o foco deste estudo, foi selecionado empiricamente um valor de $k = 150$, para ...... Na Tabela \ref{table:top10_ss150} são apresentadas as 10 palavras mais frequentes em cada um dos livros, com base na aplicação do algoritmo com $k = 150$, juntamente com a sua contagem estimada, e um código de cores nas palavras, com a mesma finalidade que anteriormente. % POR ACABAR A RAZÃO: RESULTADOS MELHORES E Q ...
...
TALVEZ MUDAR A ORDEM DAS ANALISES ??? % mudar ordem analises ?
...
\subsection{Análise de RANKS ?} % mudar nome subsection
